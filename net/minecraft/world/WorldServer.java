...
/**
 * 服务器端世界类，继承自 World 类，负责处理服务器端的世界逻辑，包括实体管理、区块生成和玩家管理等。
 */
public class WorldServer extends World
{
    /** 日志记录器，用于记录日志信息。 */
    private static final Logger logger = LogManager.getLogger();
    /** 服务器实例，用于与 Minecraft 服务器进行交互。 */
    private final MinecraftServer mcServer;
    /** 实体追踪器，用于追踪和管理世界中的实体。 */
    private final EntityTracker theEntityTracker;
    /** 玩家管理器，用于管理和跟踪玩家的状态和数据。 */
    private final PlayerManager thePlayerManager;
    /** 等待处理的 TickList 条目集合，使用 HashSet 存储。 */
    private Set pendingTickListEntriesHashSet;
    /** 所有将在未来 Tick 中处理的工作，使用 TreeSet 存储。 */
    private TreeSet pendingTickListEntriesTreeSet;
    /** 区块提供器服务器，负责提供和生成区块。 */
    public ChunkProviderServer theChunkProviderServer;
    /** 是否启用世界保存。 */
    public boolean levelSaving;
    /** 如果有玩家在游戏中，表示是否所有玩家都在睡觉。 */
    private boolean allPlayersSleeping;
    /** 实体更新的 Tick 计数器。 */
    private int updateEntityTick;
    /** 实体传送器，用于在实体进入维度时进行传送。 */
